...
BOOL DMAMem::VmmManager::writeMemory(DWORD pid, QWORD remoteAddress, void* source, int size)
{
	return VMMDLL_MemWrite(this->getVmm(), pid, remoteAddress, (PBYTE)source, size);
}
