...
static void DrawString(float fontSize, int x, int y, ImColor color, bool bCenter, bool stroke, const char* pText, ...)
{
	va_list va_alist;
	char buf[1024] = { 0 };
...
static void DrawNewText(int x, int y, ImColor color, const char* str)
{
	ImFont a;
...
static void DrawStringWithBackGround(int x, int y, RGBA* back_color, ImColor main_color, const char* pText, ...)
{
	va_list va_alist;
	char buf[1024] = { 0 };
	va_start(va_alist, pText);
	...
	DrawNewText(mid_width + 6.f, (y - 25.f) + 2.f, ImColor(main_color), text.c_str());

}

static void DrawPlayerBar(int x, int y, RGBA* back_color, ImColor main_color, const char* pText, ...)
{
	va_list va_alist;
	char buf[1024] = { 0 };
	va_start(va_alist, pText);
...
static void DrawPlayerText(int x, int y, ImColor main_color, const char* pText, ...)
{
	va_list va_alist;
	char buf[1024] = { 0 };
	va_start(va_alist, pText);
	...
	DrawNewText(x, y, ImColor(main_color), text.c_str());
}